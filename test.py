...
parser.add_argument('--save_dir', type=str, default='./saved_models/Finance', help='Root dir for saving models.')
...
gcn_model.load(model_save_dir + '/gcn_model.pt')

lstm_model =  atae_lstm()
lstm_model.load_weights(model_save_dir + '/lstm_model.h5')
...
for i, batch in enumerate(test_batch):
    ...
    lstm_out = lstm_model.predict(train_data,verbose=0)
    print(lstm_out)
    gcn_out = gcn_model.predict(batch)[0]
